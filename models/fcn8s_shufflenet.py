...
#            currvars= get_vars_underscope(tf.compat.v1.get_variable_scope().name, 'upscore2')
#            for v in currvars:
#                tf.compat.v1.add_to_collection('decoding_trainable_vars', v)
...
#            currvars= get_vars_underscope(tf.compat.v1.get_variable_scope().name, 'score_feed1')
#            for v in currvars:
#                tf.compat.v1.add_to_collection('decoding_trainable_vars', v)
...
#            currvars= get_vars_underscope(tf.compat.v1.get_variable_scope().name, 'upscore4')
#            for v in currvars:
#                tf.compat.v1.add_to_collection('decoding_trainable_vars', v)
            ...
            self.score_feed2 = conv2d('score_feed2', x=self.encoder.feed2, batchnorm_enabled=self.args.batchnorm_enabled, is_training= self.is_training,
                                      num_filters=self.params.num_classes, kernel_size=(1, 1), bias=self.args.bias,
                                      l2_strength=self.encoder.wd)
#            currvars= get_vars_underscope(tf.compat.v1.get_variable_scope().name, 'score_feed2')
#            for v in currvars:
#                tf.compat.v1.add_to_collection('decoding_trainable_vars', v)
...
#            currvars= get_vars_underscope(tf.compat.v1.get_variable_scope().name, 'upscore8')
#            for v in currvars:
#                tf.compat.v1.add_to_collection('decoding_trainable_vars', v)
