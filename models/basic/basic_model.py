...
class BasicModel:
    ...
    def init_input(self):
        with tf.name_scope('input'):
            ...
            self.y_pl = tf.compat.v1.placeholder(tf.int32, [self.args.batch_size, self.params.img_height, self.params.img_width])
            #            self.curr_learning_rate= tf.compat.v1.placeholder(tf.float32)
    ...
    def init_train(self):
        with tf.name_scope('loss'):
            ...
            self.regularization_loss = tf.reduce_sum(tf.compat.v1.get_collection(tf.compat.v1.GraphKeys.REGULARIZATION_LOSSES))
    ...
    def init_summaries(self):
        ...
        with tf.name_scope('train-summary'):
            ...
            tf.compat.v1.summary.scalar('pixel_wise_accuracy', self.accuracy)
        ...
        self.best_iou_input = tf.compat.v1.placeholder('float32', None, name='best_iou_input')
