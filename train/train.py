...
class Train(BasicTrain):
    ...
    def init_tfdata(self, batch_size, main_dir, resize_shape, mode='train'):
        self.data_session = tf.compat.v1.Session()
    ...
    def init_summaries(self):
        ...
        :return:
        """
        with tf.compat.v1.variable_scope('train-summary-per-epoch'):
    ...
    def load_test_data(self):
        ...
        self.names_mapper = {'Y': np.load(self.args.data_dir + "ynames_val.npy"),}
        self.test_data_len = self.test_data['X'].shape[0] - self.test_data['X'].shape[0] % self.args.batch_size
    ...
    def debug_layers(self):
        ...
        layers = tf.compat.v1.get_collection('debug_layers')
        ...
        ##        conv_w1 = tf.compat.v1.get_variable('my_weights', [3,3,128,128], tf.float32, initializer=init, trainable=True)
        ...
        ##        bias1= tf.compat.v1.get_variable('my_bias', 128, tf.float32, tf.constant_initializer(bias))
