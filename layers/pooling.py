...
def max_pool_2d(x, size=(2, 2), stride=(2, 2), name='pooling'):
    ...
    return tf.nn.max_pool2d(x, ksize=[1, size_x, size_y, 1], strides=[1, stride_x, stride_y, 1], padding='VALID',
                          name=name)
...
def avg_pool_2d(x, size=(2, 2), stride=(2, 2), name='avg_pooling', padding='VALID'):
    ...
    size_x, size_y = size
    stride_x, stride_y = stride
    return tf.nn.avg_pool2d(x, ksize=[1, size_x, size_y, 1], strides=[1, stride_x, stride_y, 1], padding=padding, name=name)
